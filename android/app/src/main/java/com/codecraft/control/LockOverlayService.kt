...
class LockOverlayService : Service() {
    ...
    override fun onCreate() {
        ...
        // El botón de prueba ha sido removido para producción.
        // El dispositivo solo se puede desbloquear mediante el comando oficial de la API.
        ...
        val params = WindowManager.LayoutParams(
            ...
            // make it full screen and keep screen on
